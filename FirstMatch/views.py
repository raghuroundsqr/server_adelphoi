        ...
        if serializer.validated_data.get('Exclusionary_Criteria') == False:
            ...
            if query.count() > 0:
                if serializer.validated_data.get('gender') == 1:
                    ...
                    query_default = Adelphoi_Mapping.objects.filter(program_type=program_type[0],
...
class RecommndedProgramPCR(UpdateAPIView):
    ...
    def put(self, request, *args, **kwargs):
        ...
        query_loc_facility = Adelphoi_Mapping.objects.filter(gender=mt.gender, program_type=client_selected_program,
                                                             default_level_facility=True)
        ...
        dt = {'EpisodeNumber': mt.episode_number,
              ...
              'Gender': mt.gender, 'LS_Type': mt.ls_type, 'CYF_code': mt.CYF_code, 'RefSourceName': mt.RefSourceCode}
