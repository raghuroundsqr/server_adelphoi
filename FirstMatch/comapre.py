        ...
        if not serializer.validated_data.get('Exclusionary_Criteria'):
            ...
            level_model = pickle.load(
                open(
                    ...
                    "sources/new_pickles/R_LR_LC_11march.sav",
                    "rb"
                )
            )
            program_model = pickle.load(
                open(
                    "D:/Production_26022020/adelphoi-django/server_adelphoi/"
                    "sources/new_pickles/R_DT_P_11march.sav",
                    "rb"
                )
            )
            facility_model = pickle.load(
                open(
                    "D:/Production_26022020/adelphoi-django/server_adelphoi/"
                    "sources/new_pickles/R_LR_FT_11march.sav",
                    "rb"
                )
            )
            PC_model = pickle.load(
                open(
                    "D:/Production_26022020/adelphoi-django/server_adelphoi/"
                    "sources/new_pickles/R_LR_PC_11march.sav",
                    "rb"
                )
            )
