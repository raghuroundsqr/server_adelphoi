...
class ModelTests(models.Model):
    ...
    length_living_home = ((0, '0-6 months'), (1, '6-12 months'), (2, '12+ months'))
    ...
    referred_program_choices = (("ISM","ISM"),("ISF","ISF"),("MHFO","MHFO"),("SUBAB","SUBAB"),("SEXOF-MH","SEXOF-MH"),("SEXOF-SECURE","SEXOF-SECURE"),("SEXOF","SEXOF"),("SECURE-MALE","SECURE-MALE"),("SECURE-FEMALE","SECURE-FEMALE"),("INDEPENDENT LIVING","Independent Living"),("Transitional Living","Transitional Living"))
    ...
    length_of_time_since_living_at_home = models.IntegerField(db_column='Length_of_time_since_living_at_home',choices=length_living_home)
    ...
    #####
    #social/family Hx:
    incarcerated_caregivers = models.IntegerField(db_column='Incarcerated_caregivers', choices=no_or_yes,blank=True,null = True)
    death_Caregiver = models.IntegerField(db_column='Death_Caregiver', choices=no_or_yes,null = True)
    incarcerated_siblings = models.IntegerField(db_column='Incarcerated_siblings', choices=no_or_yes,null = True)
    death_Silblings = models.IntegerField(db_column='Death_Silblings', choices=no_or_yes,null = True)
    alcohol_Use = models.IntegerField(db_column='Alcohol_Use', choices=no_or_yes,null = True)
    drug_Use = models.IntegerField(db_column='Drug_Use', choices=no_or_yes,null = True)
    abuse_neglect = models.IntegerField(db_column='abuse_neglect',choices=no_or_yes,null = True)
    #Assessment Score:
    yls_FamCircumstances_Score = models.IntegerField(db_column='YLS_FamCircumstances_Score', blank=True,null = True)
    yls_Edu_Employ_Score = models.IntegerField(db_column='YLS_Edu_Employ_Score', blank=True,null = True)
    yls_Peer_Score = models.IntegerField(db_column='YLS_Peer_Score', blank=True,null = True)
    yls_Subab_Score = models.IntegerField(db_column='YLS_Subab_Score', blank=True,null = True)
    yls_Leisure_Score = models.IntegerField(db_column='YLS_Leisure_Score', blank=True,null = True)
    yls_Personality_Score = models.IntegerField(db_column='YLS_Personality_Score', blank=True,null = True)
    yls_Attitude_Score = models.IntegerField(db_column='YLS_Attitude_Score', blank=True,null = True)
    yls_PriorCurrentOffenses_Score = models.IntegerField(db_column='YLS_PriorCurrentOffenses_Score', blank=True,null = True)
    family_support = models.IntegerField(db_column='family_support', null=True,blank=True)
    fire_setting = models.IntegerField(db_column='fire_setting', null=True,blank=True)
    level_of_aggression = models.IntegerField(db_column='level_of_aggression', null=True,blank=True)
    client_self_harm = models.IntegerField(db_column='Client_self_harm',blank=True,null = True)


    Screening_tool_Trauma = models.IntegerField(db_column ='Screening_tool_Trauma',blank=True,null = True)

    cans_LifeFunctioning = models.IntegerField(db_column='CANS_LifeFunctioning', blank=True,null = True)
    cans_YouthStrengths = models.IntegerField(db_column='CANS_YouthStrengths', blank=True,null = True)
    cans_CareGiverStrengths = models.IntegerField(db_column='CANS_CareGiverStrengths', blank=True,null = True)
    cans_Culture = models.IntegerField(db_column='CANS_Culture', blank=True,null = True)
    cans_YouthBehavior = models.IntegerField(db_column='CANS_YouthBehavior', blank=True,null = True)
    cans_YouthRisk = models.IntegerField(db_column='CANS_YouthRisk', blank=True,null = True)
    cans_Trauma_Exp = models.IntegerField(db_column='CANS_Trauma_Exp', blank=True,null = True)


    # primaryRaceCode = models.IntegerField(db_column='PrimaryRacecode', choices=RACE_CHOICES,null = True)
    ageAtEpisodeStart = models.IntegerField(db_column='AgeAtEpisodeStart',null = True)
    ageAtEnrollStart = models.IntegerField(db_column='AgeAtEnrollStart',null = True)
...
#############################
    ...
    Program_Completion = models.IntegerField(db_column='Program_Completion', choices=no_or_yes,null=True)
    Returned_to_Care = models.IntegerField(db_column='Returned_to_Care', choices=no_or_yes,null=True)
    program_significantly_modified=models.IntegerField(db_column='program_significantly_modified',choices=no_or_yes,null=True)
...
#####################################
    ...
    english_second_lang = models.IntegerField(db_column='english_second_lang',choices=second_lang,null = True)
    type_of_drugs = models.TextField(db_column='type_of_drugs',blank=True,null = True)
    FAST_FamilyTogetherScore = models.IntegerField(db_column='FAST_FamilyTogetherScore',blank=True,null = True)
    FAST_CaregiverAdvocacyScore = models.IntegerField(db_column='FAST_CaregiverAdvocacyScore',blank=True,null = True)
...
class Adelphoi_Mapping(models.Model):
    ...
    default_level_facility = models.BooleanField(db_column='default_level_facility')
