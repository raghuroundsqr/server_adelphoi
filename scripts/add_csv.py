...
# --script-args C:/Users/Raghu/Downloads/saturday_7_0.xlsx
...
def run(*args):
    ...
    numeric_cols = ['PrimaryRacecode', 'SecondaryRaceCode', 'PrimaryLanguage',
                    'CYF_code',
                    'EnrollmentStatus', 'Level_of_Care', 'RefSourceCode',
                    'ClientDischarge',
                    'ReturntoCare_c',
                    ...
                    'Family support', 'Level of aggression',
                    'Fire setting',
                    'Client self-harm', 'Abuse, or neglect',
    ...
    for i in df.to_dict('records'):
        ModelTests(episode_start=i['EpisodeStart'],
                ...
                'Borderline IQ (below 70)'],
                   ...
                   drug_Use=i['Drug Use'], abuse_neglect=i[
                'Abuse, or neglect'],
                   ...
                   program=i['Program'],
                   facility_type=i['FacilityType']).save()
