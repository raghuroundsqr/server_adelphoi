...
import datetime
def run():
    df = pd.read_excel('C:/Users/Raghu/Downloads/saturday_7_0.xlsx')
    ...
    df[['Type of drugs listed','ClientDx', 'Level of care of previous termination']]=df[['Type of drugs listed','ClientDx', 'Level of care of previous termination']].astype(str)
    dir = r'D:\Adelphoi\AdelphoiProject\\'
    try:
        os.makedirs(dir+'Csv_files/'+'/')
        print("came to directory")
    except:
        pass
    reportfilename = str(str(datetime.datetime.now().strftime('%Y-%m-%d')) + ".csv")

    csv_file_path = dir + 'Csv_files' + '/' + reportfilename
